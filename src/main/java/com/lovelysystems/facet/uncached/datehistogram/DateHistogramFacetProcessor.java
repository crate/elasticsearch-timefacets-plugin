...
public class DateHistogramFacetProcessor extends AbstractComponent implements FacetProcessor {
    ...
    private final org.elasticsearch.common.collect.ImmutableMap<String, DateFieldParser> dateFieldParsers;
    ...
    @Override
    public String[] types() {
        return new String[]{InternalFullDateHistogramFacet.TYPE, "uncachedDateHistogram"};
    }
    ...
    public FacetCollector parse(String facetName, XContentParser parser, SearchContext context) throws IOException {
        ...
        if (valueField == null) {
            throw new FacetPhaseExecutionException(facetName, "value field is required to be set for the uncached histogram facet");
        }
        ...
        return new DateHistogramFacetCollector(facetName, keyField, valueField, dateTime, interval, comparatorType, context);
    }
